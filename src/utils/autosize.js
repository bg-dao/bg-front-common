...
function assign(ta) {
  ...
  function setHeight({
    ...
    //   // let tLine = document.querySelector('#inputLine')
    //   // if (tLine) tLine.style.height = newHeight - 20 + "px"
    //   // let tLayout = document.querySelector('#functionInput')
    //   // if (tLayout) tLayout.style.height = newHeight + "px"

    //   let tTexarea = document.querySelector('#inputTextarea')
    //   if (tTexarea) tTexarea.style.height = newHeight + "px"
    // } else {
    //   // let tLine = document.querySelector('#inputLine')
    //   // if (tLine) tLine.style.height = newHeight - 22 + "px"
    //   // let tLayout = document.querySelector('#functionInput')
    //   // if (tLayout) tLayout.style.height = newHeight + "px"
